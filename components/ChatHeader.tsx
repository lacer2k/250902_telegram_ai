...
import { LivioAcerboLogoIcon, MenuIcon } from './icons';
      ...
      <div className='flex items-center'>
        <div className="relative">
          <div className="w-12 h-12 rounded-full flex items-center justify-center">
             <LivioAcerboLogoIcon className="w-full h-full" />
          </div>
          <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-400 border-2 border-gray-800"></span>
        </div>
        <div className="ml-4">
          <h2 className="text-xl font-semibold text-white">Livio Acerbo AI Assistant</h2>
